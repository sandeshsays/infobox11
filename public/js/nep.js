...
function setSelectedDay(t) {
    ...
    $("#" + e).val(t),
        ndpAttr.ndpEnglishInput &&
            $("#" + ndpAttr.ndpEnglishInput).val(BS2AD(t)),
        hideCalendarBox();
    var eid = "#" + e;
    $(eid).trigger("change");
}
...
function getMonthSelect(t, e) {
    var n = getNepaliMonthsInNepali(),
        a =
            '<select id="npd-month-select" onchange="performSelectMonth(' +
            e +
            ')">';
    return (
...
function getYearSelect(t, e, n) {
    ...
    for (
        i =
            Math.round(n / 2) > 0 && parseInt(e) - Math.round(n / 2) >= 1969
...
function NepaliDateConverter() {
    (this.bs_date_eq = "09/18/1970"),
        (this.ad_date_eq = "01/01/1914"),
        (this.bs = []),
        // (this.bs[1969] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30]),
        (this.bs[1970] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30]),
        (this.bs[1971] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30]),
        (this.bs[1972] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31]),
        (this.bs[1973] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31]),
        (this.bs[1974] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30]),
        (this.bs[1975] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30]),
        ...
        (this.bs[2081] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30]),
